...
evaluate.DTR <- function(scenario="linear_interaction", approach = "causaltree", n = 5000, minsize = 20){
  ...
  # Models
  outcome.mod <- list(~C1 + C2 + X11 + X12  + X14 + X15 + X18 + X19,
                      ~C1 + C2 + X21 + X22  + X24 + X25 + X28 + X29 + A1 + (X11 + X12  + X14 + X15 + X18 + X19),
                      ~C1 + C2 + X31 + X32  + X34 + X35 + X38 + X39 + A2 + (X21 + X22  + X24 + X25 + X28 + X29) + A1 + (X11 + X12  + X14 + X15 + X18 + X19))
  treatment.mod <- list(A1 ~ C1 + C2 + X11 + X12 , 
                        A2 ~ C1 + C2 + X21 + X22  + A1 + (X11 + X12  + X19),
                        A3 ~ C1 + C2 + X31 + X32  + A1 + (X11 + X12  + X19) + A2 + (X21 + X22  + X29))
